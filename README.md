...
Open the notebook with Jupyter / VS Code / Kaggle:

```bash
jupyter notebook brain_mri_segmentation.ipynb
```

### A) From scratch — training the model (with weights generated by you)
...
### B) With ready-made weights — without retraining
